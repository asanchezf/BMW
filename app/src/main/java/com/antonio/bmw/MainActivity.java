...
public class MainActivity extends AppCompatActivity implements AdaptadorRecyclerViewSearch.OnItemClickListener, SearchView.OnQueryTextListener, android.support.v7.widget.SearchView.OnQueryTextListener, MenuItemCompat.OnActionExpandListener {
        ...
        dialogImportar.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int boton) {
                        ...
                        pDialog.setTitle("ACTUALIZANDO TUS CONTACTOS");
